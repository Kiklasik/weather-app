...
$link = mysqli_connect("127.0.0.1", "admin", "cukVMx97dbdR", "weather");
...
$resultold = mysqli_query($link, $lastweek);
...
<div class="main">
<div class="navbar">
<a  href="weather-app-DATE.php">Aktualne</a>
<a class="active" href="weather-app.php">Tydzień</a>
<a href="#contact">Miesiąc</a>

</div>

<div class="zmiana">
    <p><?php echo date('d / m / Y', strtotime('-1 week', strtotime($new_date)))?> - <?php echo date('d / m / Y', strtotime(($new_date)))?> </p>
    <table>
  <tr>
...
<div class="menu">
  ...
  <form class="filter" name="Filter" method="POST">
    <button type="submit" name="dateFrom" value="<?php echo ($new_date=date('d-m-Y', strtotime('-1 week', strtotime($new_date)))); ?>"> <</button>
    <?php echo$new_date=date('d-m-Y', strtotime($new_date.'+1 week'))?>
    <button type="submit" name="dateFrom" value="<?php echo ($new_date=date('d-m-Y', strtotime($new_date.'+1 week'))); ?>"> ></button>
  </form>
</div>
